...
<acme:form>
	...
	<acme:input-textbox code="administrator.airport.form.label.iata-code" path="iataCode"/>
	<acme:input-select code="administrator.airport.form.label.operational-scope" path="operationalScope" choices="${operationalScopes}"/>
	...
	<acme:input-textbox code="administrator.airport.form.label.contact-phone-number" path="contactPhoneNumber"/>
